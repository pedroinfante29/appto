 	...
 	<div class="navbar navbar-expand-md navbar-dark">
		<div class="navbar-brand">
			<a href="index.html" class="d-inline-block">
				<img src="<?= base_url('limitless_dashboard_bootstrap_4-main/global_assets/images/logo_light.png') ?>" alt="">
			</a>
		</div>
			...
			<ul class="navbar-nav">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-300">
						...
						<div class="dropdown-content-body dropdown-scrollable">
							<ul class="media-list">
								<li class="media">
									<div class="mr-3">
										<img src="<?= base_url('limitless_dashboard_bootstrap_4-main/global_assets/images/placeholders/placeholder.jpg') ?>" width="36" height="36" class="rounded-circle" alt="">
									</div>
									<div class="media-body">
				...
				<li class="nav-item dropdown dropdown-user">
					<a href="#" class="navbar-nav-link d-flex align-items-center dropdown-toggle" data-toggle="dropdown">
						<img src="<?= base_url('limitless_dashboard_bootstrap_4-main/global_assets/images/placeholders/placeholder.jpg') ?>" class="rounded-circle mr-2" height="34" alt="">
						<span>Pedrety</span>
					</a>
			...
			<div class="sidebar-content">
				...
				<div class="sidebar-user">
					<div class="card-body">
						<div class="media">
							<div class="mr-3">
								<a href="#"><img src="<?= base_url('limitless_dashboard_bootstrap_4-main/global_assets/images/placeholders/placeholder.jpg') ?>" width="38" height="38" class="rounded-circle" alt=""></a>
							</div>
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								...
								<li class="nav-item"><a href="<?= base_url('limitless_dashboard_bootstrap_4-main/layout_2/LTR/default/full/index.html') ?>" class="nav-link">Layout 2</a></li>
								<li class="nav-item"><a href="<?= base_url('limitless_dashboard_bootstrap_4-main/layout_3/LTR/default/full/index.html') ?>" class="nav-link">Layout 3</a></li>
								<li class="nav-item"><a href="<?= base_url('limitless_dashboard_bootstrap_4-main/layout_4/LTR/default/full/index.html') ?>" class="nav-link">Layout 4</a></li>
								<li class="nav-item"><a href="<?= base_url('limitless_dashboard_bootstrap_4-main/layout_5/LTR/default/full/index.html') ?>" class="nav-link">Layout 5</a></li>
								<li class="nav-item"><a href="<?= base_url('limitless_dashboard_bootstrap_4-main/layout_6/LTR/default/full/index.html') ?>" class="nav-link disabled">Layout 6 <span class="badge bg-transparent align-self-center ml-auto">Coming soon</span></a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Themes">
								...
								<li class="nav-item"><a href="<?= base_url('limitless_dashboard_bootstrap_4-main/LTR/material/full/index.html') ?>" class="nav-link">Material</a></li>
								<li class="nav-item"><a href="<?= base_url('limitless_dashboard_bootstrap_4-main/LTR/dark/full/index.html') ?>" class="nav-link disabled">Dark <span class="badge bg-transparent align-self-center ml-auto">Coming soon</span></a></li>
								<li class="nav-item"><a href="<?= base_url('limitless_dashboard_bootstrap_4-main/LTR/clean/full/index.html') ?>" class="nav-link disabled">Clean <span class="badge bg-transparent align-self-center ml-auto">Coming soon</span></a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
